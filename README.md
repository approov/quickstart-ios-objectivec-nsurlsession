...
target 'YourApplication' do
    use_frameworks!
    platform :ios, '10.0'
    pod 'approov-service-nsurlsession', '3.0.2', :source => "https://github.com/approov/approov-service-nsurlsession.git"
...
target 'YourApplication' do
    use_frameworks!
    platform :ios, '10.0'
    pod 'approov-service-nsurlsession', '3.0.2-bitcode', :source => "https://github.com/approov/approov-service-nsurlsession.git"
